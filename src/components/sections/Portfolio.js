    ...
    return(
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-codeitout">Codeitout</li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
            <Project title = "Codeitout" stack = "React, Node.js, Express" description= "Browser code editing tool" filter = 'filter-codeitout' image = {process.env.PUBLIC_URL + './img/portfolio/codeitout.png'} githubLink = "https://github.com/jihoshin28/codeitout" liveLink = "https://www.npmjs.com/package/codeitout/"/>
